...
void segments_install_gdt()
{
	...
	print("gdt.address: "); kernelPrintInt((unsigned int)gdt_ptr);
	print("gdt.address: "); kernelPrintInt(gdt_ptr->address);
	print("gdt.address: "); kernelPrintInt(((unsigned int)&gdt_descriptors[0]));
	print("gdt.address: "); kernelPrintInt((unsigned int)&gdt_ptr->address);
	print("gdt.size: "); kernelPrintInt(gdt_ptr->size);
